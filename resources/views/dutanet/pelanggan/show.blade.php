                                ...
                                <form action="/masteruser" method="post" class="form form-horizontal">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <label class="text-black">Last Login</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input type="text" class="form-control" value="{{ $user->last_login }}"
                                                    disabled>
                                            </div>
                                            <div class="col-md-4">
                                                <label class="text-black">Akun Dibuat</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                            ...
                                            <div class="col-md-4">
                                                <label class="text-black">Password (encrypt)</label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                            ...
                                            <div class="col-sm-12 d-flex justify-content-end">
                                                ...
                                                <a href="/masteruser/{{ $user->id }}/edit"
                                                    class="btn btn-warning me-1 mb-1"><span data-feather="edit"></span>
                                                    Edit</a>
                                                @if ($user->role == 'Admin')
                                                @else
                                                    <form action="/masteruser/{{ $user->id }}" method="post"
                                                        class="d-inline">
                                                        @method('delete')
                                                        @csrf
                                                        <button class="btn btn-danger me-1 mb-1"
                                                            onclick="return confirm('Hapus user dengan nama : {{ $user->name }} ?');"><span
